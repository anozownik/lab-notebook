...
DATASET['stim_duration'], DATASET['looming_duration'],  DATASET['looming_nonlinearity'] = [], [], []
...
#for i, filename in enumerate([DATASET['files'][0]]):
    ...
    if data.nROIs>0:
        ...
        DATASET['looming_duration'].append(ep.fixed_parameters['looming-duration'][0])
        DATASET['looming_nonlinearity'].append(ep.fixed_parameters['looming-nonlinearity'][0])
