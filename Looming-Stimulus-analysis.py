...
epWhiteLooming = physion.analysis.process_NWB.EpisodeData(data, 
                                                    quantities=['dFoF',
                                                                'running_speed', 'pupil_diameter', 'facemotion'],
                                                    protocol_name='looming-stim-white')
#%%
fig, AX = physion.dataviz.episodes.trial_average.plot(epWhiteLooming,
                                                      quantity='dFoF', with_std=False,
                                                      roiIndices='all',
                                                      **plot_props)
pt.show()
...
epShortLooming = physion.analysis.process_NWB.EpisodeData(data, 
                                                    quantities=['dFoF',
                                                                'running_speed', 'pupil_diameter', 'facemotion'],
                                                    protocol_name='looming-stim-250msloom')
#%%
fig, AX = physion.dataviz.episodes.trial_average.plot(epShortLooming,
                                                      quantity='dFoF', with_std=False,
                                                      roiIndices='all',
                                                      **plot_props)
pt.show()
